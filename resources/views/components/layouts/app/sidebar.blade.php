        ...
        <flux:navlist variant="outline" class="w-64">
            <flux:navlist.group class="grid">
                ...
                <flux:navlist.item
                    ...
                    wire:navigate>Clients
                </flux:navlist.item>

                <flux:navlist.item
                    icon="fire"
                    :href="route('feux.index')"
                    :current="request()->routeIs('feux.*')"
                    wire:navigate>Feux
                </flux:navlist.item>

                <flux:navlist.item
                    icon="clipboard-document-check"
                    :href="route('administratif.index')"
                    :current="request()->routeIs('administratif.*')"
                    wire:navigate>Administratif
                </flux:navlist.item>
